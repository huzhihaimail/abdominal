 ...
 * @author rain
 */
public interface FourModuleErrorCode {
    ...
    String SRVC_COMPANYDESC_SAVE_APP_ERROR_MESSAGE = "新建四大模块出现系统异常";

    /**
     * 新建用户根异常
     */
    String SRVC_COMPANYDESC_SAVE_ERROR_CODE = SRVC_COMPANYDESC + "2";
    String SRVC_COMPANYDESC_SAVE_ERROR_MESSAGE = "新建四大模块出现根异常";

    /**
     * 更新用户系统异常
     */
    String SRVC_COMPANYDESC_UPDATE_APP_ERROR_CODE = SRVC_COMPANYDESC + "3";
    String SRVC_COMPANYDESC_UPDATE_APP_ERROR_MESSAGE = "更新四大模块出现系统异常";

    /**
     * 更新用户根异常
     */
    String SRVC_COMPANYDESC_UPDATE_ERROR_CODE = SRVC_COMPANYDESC + "4";
    String SRVC_COMPANYDESC_UPDATE_ERROR_MESSAGE = "更新四大模块出现根异常";
    ...
    String SRVC_COMPANYDESC_SELECT_ERROR_MESSAGE = "查询四大模块出现异常";
